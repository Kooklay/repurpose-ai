          ...
          <form action={handleSubmit} className="generate-form">
            <div className="form-field">
              ...
              >
                ...
                <br />
                ⏱️ Оптимальная длина — до 30 минут. У длинных берём первые 15 минут.
              </p>
            </div>
        ...
        {status === "loading" && (
          <div className="generate-loading">
            ...
            <p className="loading-hint">
              Обычно 30–60 секунд. У длинных видео — до 2 минут.
            </p>
          </div>
        )}
        ...
        {status === "error" && (
          <div className="generate-error">
            ...
            >
              ...
              <div>
                • Выбрать видео покороче — оптимально до 30 минут
              </div>
              <div>
                • Попробовать обучающее видео, интервью или подкаст — у них
