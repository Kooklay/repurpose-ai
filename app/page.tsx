      ...
      <section id="faq" className="section">
        <div className="section-inner">
          ...
          <div className="faq-list">
                 {[
                 { 
                  q: "Какие видео поддерживаются?", 
                  a: "YouTube-видео с субтитрами — ручными или автоматическими. У большинства публичных видео субтитры включены по умолчанию. Это могут быть обучающие ролики, интервью, лекции, подкасты." 
                  },
                 { 
                 q: "Что делать если у видео нет субтитров?", 
                  a: "Выберите другое видео. Обычно субтитры есть у обучающих роликов, интервью и подкастов. Если автор их отключил — можно попросить включить, либо загрузить свою версию." 
                 },
                 { 
                  q: "Работает ли с русскоязычными видео?", 
                 a: "Да. Поддерживаем русские, английские и автоматически сгенерированные субтитры. Результат можно получить на русском." 
                  },
                 { 
                  q: "Можно отменить подписку?", 
                 a: "Да, в один клик в личном кабинете." 
                 },
                ].map((item) => (
